...
This dashboard visualizes multiple sets of data in relation to the attendence of Parties at Lehigh University. The graph on the left compares which type of party (on- or off-campus) people prefer to attend, broken down by gender. The two grapahs on the right ask about attendence instead of preference. They compare whether boys or girls have attended more on- or off-campus parties.
